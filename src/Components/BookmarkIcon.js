...
const BookmarkIcon = ({ articleId, size = 24, savedStatus, position = 'bottom', centered = false, iconColorOverride = null }) => {
    ...
    const iconColor = iconColorOverride !== null ? iconColorOverride : (bookmarked ? '#FF5B5B' : '#B8B8B8');
