...
const NewArticleDisclaimerScreen = ({ navigation, route }) => {
  ...
  const handleContinue = () => {
    if (!agreed) return;
    navigation?.navigate('NewArticle', { articleId, articleTitle, articleData });
  };
    ...
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      >
        <View style={styles.heroCard}>
          <Image
            ...
            resizeMode="contain"
          />
          <Text style={styles.heroTitle}>{t('articleDisclaimer.beforeYouPublish')}</Text>
        </View>
        ...
        <View style={styles.agreeRow}>
          ...
          <Text style={styles.agreeCopy}>
            {t('articleDisclaimer.agreeTermsPrefix')}
            <Text onPress={openTerms} style={styles.agreeLink}>
              {t('articleDisclaimer.agreeTermsLink')}
            </Text>
          </Text>
        </View>
      </ScrollView>
      ...
      <View style={styles.footer}>
        <Animated.View style={{ transform: [{ scale: ctaScale }], alignSelf: 'stretch' }}>
          ...
          >
            <Text style={styles.continueBtnText}>{t('articleDisclaimer.continue')}</Text>
          </Pressable>
        </Animated.View>
      </View>
    </SafeAreaView>
